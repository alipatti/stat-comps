...
emphasize similarities and differences with traditional methods 

Linear transformation + non-linearity + scale

## Training

functions with easily computable gradients
...
## Encoding as sequences

give example of raw data and the transformations

## Training

show output of training script

talk about hardware, gpu usage, etc.

## Evaluation

cross-validation

No equiv of AIC, BIC, etc.
